...
import Logo from '../../public/ping-coming-soon-page/logo.svg';
...
const PingComingSoonPageComponent = () => (
  <div className={style.container}>
    <div className={style.container_centered}>
      ...
      <div className={style.illustration_image_wrapper}><img src='/ping-coming-soon-page/illustration-dashboard.png' /></div>
