...
import IconArrow from '../../public/base-apparel-coming-soon-page/icon-arrow.svg';
import IconError from '../../public/base-apparel-coming-soon-page/icon-error.svg';
    ...
    <div className={style.container}>
      <div className={style.main_content}>
        <div className={style.main_content_header}>
          <img src="/base-apparel-coming-soon-page/logo.svg" />
        </div>
        <div className={style.image_mobile_wrapper}>
          <img src="/base-apparel-coming-soon-page/hero-mobile.jpg" />
        </div>
      ...
      <div className={style.image_desktop_wrapper}>
        <img src="/base-apparel-coming-soon-page/hero-desktop.jpg" />
      </div>
    </div>
  );
}
