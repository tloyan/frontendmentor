...
import ShareLogo from '../../public/article-preview-component/icon-share.svg';
    ...
    <div className={style.container}>
      <div className={style.article_preview_container}>
        <div className={style.article_preview_image_wrapper}>
          <img src="/article-preview-component/drawers.jpg" />
        </div>
        ...
        <div className={style.article_preview_content_author}>
            <div className={style.author_content}>
              ...
              <button className={style.author_content_description_share_button} onClick={() => setActive(true)}>
                <ShareLogo />
              </button>
            </div>
